...
GUI_Canvas::GUI_Canvas(int _x, int _y, int _width, int _height, SDL_Surface *_theme) : GUI_Widget(_x, _y, _width, _height)
{
...
void GUI_Canvas::Render(SDL_Surface *dest)
{
   SDL_Rect offset;
